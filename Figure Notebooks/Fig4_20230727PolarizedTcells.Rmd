---
title: "fig3_Polarized_and_Naive"
author: "Jack Collora"
date: "2023-07-27"
...
results_polar1<-subset(results, merged_clusters=="MemoryT_Polarized_1")
Idents(results_polar1)<-results_polar1$T_Tp
DefaultAssay(results_polar1)<-"RNA"
...
DT::datatable(rownames=TRUE, filter="top", class='cell-border stripe', extensions = 'Buttons', options = list(dom = 'Bfrtip', buttons = c('copy', 'csv', 'excel', 'pdf', 'print')), data=subset(GSEAres, padj<0.05))
...
```{r differential RNA1, fig.height=9, fig.width=16, dev='png'}
...
```{r gsea1, fig.height=9, fig.width=16, dev='png'}
...
```{r chromvar1, fig.height=9, fig.width=16, dev='png'}
...
```{r differential RNA2, fig.height=9, fig.width=16, dev='png'}
...
```{r gsea2, fig.height=9, fig.width=16, dev='png'}
...
```{r chromvar2, fig.height=9, fig.width=16, dev='png'}
